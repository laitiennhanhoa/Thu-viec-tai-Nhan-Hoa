...
Nguồn tham khảo [1](https://www.ibm.com/docs/en/zos/2.1.0?topic=descriptions-ls-list-file-directory-names-attributes) và [2](https://en.wikipedia.org/wiki/Ls#Sample_usage)
