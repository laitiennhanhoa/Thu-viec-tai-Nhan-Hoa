...
Nguồn tham khảo tại [trang ibm](https://www.ibm.com/docs/en/zos/2.1.0?topic=descriptions-ls-list-file-directory-names-attributes) và [wikipedia](https://en.wikipedia.org/wiki/Ls#Sample_usage)
